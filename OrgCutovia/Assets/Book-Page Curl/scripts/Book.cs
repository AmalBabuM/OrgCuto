...
public class Book : MonoBehaviour {
    ...
    private void CalcCurlCriticalPoints()
    {
        ...
        ebl = new Vector3(-BookPanel.rect.width / 8, -BookPanel.rect.height / 1);
        st = new Vector3(0, BookPanel.rect.height / 2);
        radius1 = Vector2.Distance(sb, ebr);
        float pageWidth = BookPanel.rect.width / 2.0f;
        float pageHeight = BookPanel.rect.height/2;
    ...
    public void DragRightPageToPoint(Vector3 point)
    {
        ...
        Left.sprite = (currentPage < bookPages.Length) ? bookPages[currentPage].sprite : background;
        Left.transform.SetAsFirstSibling();
        
        Right.gameObject.SetActive(true);
        Right.transform.position = RightNext.transform.position;
        Right.transform.eulerAngles = new Vector3(0, 0, 0);
        Right.sprite = (currentPage < bookPages.Length - 1) ? bookPages[currentPage + 1].sprite : background;

        RightNext.sprite = (currentPage < bookPages.Length - 2) ? bookPages[currentPage + 2].sprite : background;
    ...
    public void DragLeftPageToPoint(Vector3 point)
    {
        ...
        Right.sprite = bookPages[currentPage - 1].sprite;
        Right.transform.eulerAngles = new Vector3(0, 0, 0);
        Right.transform.SetAsFirstSibling();
        ...
        Left.transform.eulerAngles = new Vector3(0, 0, 0);
        Left.sprite = (currentPage >= 2) ? bookPages[currentPage - 2].sprite : background;

        LeftNext.sprite = (currentPage >= 3) ? bookPages[currentPage - 3].sprite : background;
    ...
    void UpdateSprites()
    {
        LeftNext.sprite= (currentPage > 0 && currentPage <= bookPages.Length) ? bookPages[currentPage-1].sprite : background;
        RightNext.sprite=(currentPage>=0 &&currentPage<bookPages.Length) ? bookPages[currentPage].sprite : background;
    }
